export default function Navbar() {
  return (
    <div className="w-screen h-28 md:h-16 shadow-lg md:shadow-lg flex justify-center items-center text-gray-700 bg-white">
      <div className="p-6 w-full h-full grid grid-cols-1 grid-rows-2 justify-center items-center gap-8 md:justify-start md:grid-cols-2 md:grid-rows-1">
        <div className="text-4xl flex justify-center md:justify-between items-center">
        ...
        <div className="w-full flex flex-row justify-center items-center gap-x-6 md:justify-end">
          <div className="text-lg md:text-lg select-all pl-4">kyleghuang@gmail.com</div>
